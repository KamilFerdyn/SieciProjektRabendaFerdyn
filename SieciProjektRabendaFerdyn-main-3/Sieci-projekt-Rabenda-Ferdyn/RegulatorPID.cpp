...
double RegulatorPID::symuluj(double wartoscWe) {
    ...
    i = (wspolczynnikCalkujacy > 0) ? (1.0 / wspolczynnikCalkujacy) * sumaBledowDoSkladnikaCalkujacego : 0.0;
    d = (wspolczynnikRozniczkujacy > 0) ? wspolczynnikRozniczkujacy * (blad - bladPoprzedniejIteracji) : 0.0;
